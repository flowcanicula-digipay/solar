...
- Solar panels → "tấm pin năng lượng mặt trời" (first mention), "pin mặt trời" (subsequent)
- Solar electricity → "điện mặt trời"
- Grid-tied → "hòa lưới điện"
- Bill savings → "tiết kiệm tiền điện"
- Installation → "lắp đặt"
- System design → "thiết kế hệ thống"
- After-sales support → "hỗ trợ sau lắp đặt"
- Maintenance → "bảo trì"
- Warranty → "bảo hành"
- Panel warranty → "bảo hành tấm pin 25 năm"
- Workmanship warranty → "bảo hành thi công"
- Roof waterproofing warranty → "bảo hành chống thấm mái"
- Free callout period → "12 tháng hỗ trợ miễn phí"
- Annual maintenance plan → "gói bảo trì hàng năm"
- EVN → "EVN" (universally known in Vietnam)
- DOIT notification → "thông báo Sở Công Thương"
- Decree 135 → "Nghị định 135/2024/NĐ-CP"
...
- Maintenance → メンテナンス
- Annual maintenance plan → 年間メンテナンスプラン
- Warranty → 保証 (ほしょう)
- 25-year output guarantee → 25年出力保証
- Workmanship warranty → 施工保証
- Roof waterproofing warranty → 防水保証
- 12-month free support → 12ヶ月無償サポート
- Free site assessment → 無料現地調査
...
8 questions. Accurate to Decree 135/2024/ND-CP and to the full 8-phase service
process described in STORY.md.
...
1. **Under Vietnam's current rules, how much surplus power can I sell to EVN?**
   ...
   purpose of your system must be self-consumption — your system size must
   generally match your existing electricity load at registration. Surplus is
   compensated at the preceding year's average electricity market price. For
   most residential clients, the financial case for solar is built on
   self-consumption savings, not export revenue. SolarTNP sizes your system
   to your actual load precisely so you maximise self-consumption.

2. **What approvals do I need before installation?**
   For systems under 100 kW (all residential, most small commercial): a
   simplified notification to the provincial Department of Industry and Trade
   (DOIT) — no full investment approval required. After installation, EVN
   performs a grid inspection before connecting bi-directional metering.
   SolarTNP handles both the DOIT notification and the EVN application
   entirely — you sign the contract and we manage the paperwork. Typical
   timeline from DOIT submission to EVN energisation: 4–8 weeks depending
   on province.

3. **Does my building need to comply with any requirements?**
   Yes. Decree 135/2024/ND-CP requires the building to be compliant with
   construction law, land-use rights, fire safety, and environmental
   regulations. SolarTNP checks this during the free site assessment. We
   will not proceed on a non-compliant building — this protects you.

4. **Will the panels survive typhoons?**
   Our mounting systems are rated for wind loads significantly above Vietnam's
   building code minimums. We use Japanese-grade aluminium rails and stainless
   steel fasteners anchored into roof structure — not just the surface material.
   Every installation includes a structural load calculation. We have designed
   specifically for the Vietnamese climate.

5. **What roof types can you work with?**
   Concrete flat roofs, Vietnamese tile roofs (ngói), corrugated metal (tôn),
   and composite or fibre-cement roofing — each uses a different mounting method.
...
7. **What does your warranty actually cover?**
   ...
   guarantee on panels (≤0.45%/yr degradation from the panel manufacturer),
   5–10 year inverter warranty (manufacturer), 10-year mounting hardware
   warranty (SolarTNP), 2-year workmanship warranty (SolarTNP), and a 2-year
   roof waterproofing warranty (SolarTNP) covering any water ingress caused
   by the installation. For the first 12 months, all callouts are free.
   From year 2, annual maintenance plans are available.
...
8. **Can you install outside Biên Hòa and Ho Chi Minh City?**
   ...
   Long An. Remote locations are assessed case by case — travel costs are quoted
   separately for distant provinces.
