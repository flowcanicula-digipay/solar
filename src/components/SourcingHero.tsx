...
export default function SourcingHero({
  ...
  return (
    ...
    >
      ...
      {/* Layer 8 — floating sourcing motifs */}
      <div
      ...
      >
        <Image
          src={withBasePath('/assets/motifs/export-crate.svg')}
          alt=""
          width={88}
          height={88}
      ...
      <div
        className="animate-float pointer-events-none absolute right-[9%] top-[50%] hidden md:block"
        style={
          {
            '--rot': '8deg',
            animationDelay: '4.5s',
      ...
      >
        <Image
          src={withBasePath('/assets/motifs/pallet-wrap.svg')}
          alt=""
          width={56}
          height={56}
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 pb-14 pt-28 md:pb-20">
        ...
        >
          {[
            { value: 'US', unit: ' & SEA', label: 'shipping destinations' },
            { value: '25', unit: 'yr', label: 'panel output guarantee' },
            { value: '1', unit: ' source', label: 'for panels & hardware' },
          ].map((stat) => (
            <div key={stat.label}>
