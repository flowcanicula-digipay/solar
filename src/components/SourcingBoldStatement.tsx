...
export default function SourcingBoldStatement({
  variant = 'light',
  label,
  parts,
  caption,
  ...
  if (variant === 'dark') {
    return (
      <section className="relative overflow-hidden bg-navy-950 py-24">
        ...
        <div className="pointer-events-none absolute left-0 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-amber-400 opacity-[0.04] blur-[120px]" />
