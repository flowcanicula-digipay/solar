  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-navy-950 px-6 py-20 text-center text-cream-50 select-none">
      <div
        ...
        style={parallaxEnabled ? { transform: `translate(${mouse.x}px, ${mouse.y}px)` } : undefined}
      >
        <Image
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div
          ...
          className={`font-display font-bold leading-none text-[clamp(6rem,20vw,12rem)] transition-all duration-500 ${
            hovered404 ? '' : 'animate-glow'
          }`}
          style={{
            WebkitTextStroke: hovered404 ? '1.5px rgba(245,158,11,1)' : '1.5px rgba(245,158,11,0.65)',
            color: hovered404 ? 'rgba(245,158,11,0.12)' : 'transparent',
            filter: hovered404
              ? 'drop-shadow(0 0 40px rgba(245,158,11,0.7)) drop-shadow(0 0 100px rgba(245,158,11,0.25))'
              : undefined,
          }}
